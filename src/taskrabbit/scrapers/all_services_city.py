...
def crawl_site(url, city, task):
    ...
    browser = webdriver.Chrome("C:/Users/ahg05/Desktop/chromedriver.exe", chrome_options=chrome_options)
...
with open('services_ca.json') as f:
    entries = json.load(f)
...
for city in cities:
    for entry in entries:
        ...
        try:
            ...
            crawl_site(website + entry['url'], city['city'], entry['task_title'])
